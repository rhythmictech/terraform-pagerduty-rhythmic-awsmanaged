  ...
  config {
    ...
    jira {
      ...
      dynamic "custom_fields" {
        for_each = coalesce(jsondecode(nonsensitive(data.aws_ssm_parameter.jira_account_custom_jira_fields.value)), [])
      ...
      dynamic "custom_fields" {
        for_each = coalesce(jsondecode(nonsensitive(data.aws_ssm_parameter.jira_account_custom_fixed_fields.value)), [])
